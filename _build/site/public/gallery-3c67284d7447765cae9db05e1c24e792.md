...
| 10 | [Scientific colour palettes](./colour-palettes.md) | Python · matplotlib · R | Four palette families (qualitative / sequential / diverging / geospatial-map), each on the research chart it belongs on, with rules |
