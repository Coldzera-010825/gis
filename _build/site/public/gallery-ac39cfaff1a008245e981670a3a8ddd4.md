...
| 09 | [Correlation heatmaps & Mantel networks](./correlation-heatmaps.md) | Python · seaborn · R · linkET | Annotated / triangular / clustered heatmaps; the ecology-standard Mantel-network figure (ggcor → linkET) |
